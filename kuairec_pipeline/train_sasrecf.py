"""Training entry-point for RecBole's feature-aware SASRec (SASRecF)."""
...
DEFAULT_CONFIG = Path(__file__).resolve().parent.parent / "configs" / "kuairec_sasrecf.yaml"
...
def _parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = build_parser(
        __doc__ or "Train SASRecF on KuaiRec.",
        default_config=DEFAULT_CONFIG,
        default_model="SASRecF",
    )
